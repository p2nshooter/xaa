...
const CARE_T: Record<Exclude<Lang, 'en'>, Record<string, { blurb: string; hours: string; response: string; includes: string[] }>> = {
  es: {
    'care-essential': { blurb: 'Para una landing o un portafolio. Tu sitio se respalda cada día y se repara desde tu API key de IA — sin cuota mensual.', hours: 'Web-fix IA + restaurar', response: 'Backups diarios', includes: ['Backup diario con un clic, conservado 30 días', 'Restauración con un clic a cualquier punto guardado', 'Reseteo con un clic — vacía la base de datos y empieza limpio', 'Web-fix IA: la IA repara el sitio en vivo con tu key', 'Tu API key de IA cifrada, con nuestro prompt premium de reparación integrado', 'Cada backup, restauración y reseteo escrito en el registro del proyecto'] },
    'care-growth': { blurb: 'Para un sitio de empresa que tiene que seguir en pie. Backups diarios y semanales, recuperación IA más profunda, más historial.', hours: 'Web-fix + restaurar + resetear', response: 'Diario · semanal', includes: ['Todo lo de Essential', 'Backups diarios y semanales, conservados 90 días', 'Recuperación de base de datos con IA — reconstruir y re-sembrar desde un backup', 'Los backups programados se ejecutan solos, además de los botones', 'Copia de seguridad previa antes de cada restauración', 'Snapshots descargables que guardas fuera del sitio'] },
    'care-business': { blurb: 'Para plataformas y tiendas donde los datos son el negocio. Todas las cadencias, recuperación IA completa, un año de historial.', hours: 'Suite de recuperación IA completa', response: 'Diario · semanal · mensual', includes: ['Todo lo de Growth', 'Backups diarios, semanales y mensuales, conservados 12 meses', 'Recuperación IA de la app y su base de datos juntas', 'Restauración a un punto en el tiempo y reseteo selectivo de tablas', 'Comprobación de integridad tras cada backup y restauración', 'Actividad de backup y recuperación exportable para auditoría'] },
    'care-enterprise': { blurb: 'Para sistemas multi-sitio y regulados. Horarios a medida, recuperación multi-base de datos y restauraciones ensayadas — dimensionado a tu arquitectura.', hours: 'Recuperación IA multi-sitio', response: 'Horarios a medida', includes: ['Todo lo de Business', 'Backup y recuperación en varios sitios y bases de datos', 'Retención y cadencia a medida por sistema', 'Recuperación ante desastres ensayada que puedes ejecutar a demanda', 'Trae tu propio modelo o endpoint para la recuperación IA', 'Runbook de traspaso para que tu propio equipo lo opere'] },
  },
  id: {
    'care-essential': { blurb: 'Untuk landing atau portofolio. Situs Anda mem-backup diri tiap hari dan memperbaiki diri dari API key AI Anda — tanpa biaya bulanan.', hours: 'Web-fix AI + restore', response: 'Backup harian', includes: ['Backup harian satu klik, disimpan 30 hari', 'Restore satu klik ke titik tersimpan mana pun', 'Reset satu klik — kosongkan database dan mulai bersih', 'Web-fix AI: AI memperbaiki situs langsung di atas key Anda', 'API key AI Anda tersimpan terenkripsi, prompt perbaikan premium kami tertanam', 'Tiap backup, restore, dan reset ditulis ke log proyek'] },
    'care-growth': { blurb: 'Untuk situs perusahaan yang harus tetap hidup. Backup harian dan mingguan, recovery AI lebih dalam, riwayat lebih panjang.', hours: 'Web-fix + restore + reset', response: 'Harian · mingguan', includes: ['Semua di Essential', 'Backup harian dan mingguan, disimpan 90 hari', 'Recovery database AI — bangun ulang dan isi ulang dari backup', 'Backup terjadwal berjalan otomatis, di samping tombol', 'Snapshot pengaman diambil sebelum tiap restore', 'Snapshot backup yang bisa diunduh untuk disimpan di luar'] },
    'care-business': { blurb: 'Untuk platform dan toko yang datanya adalah bisnisnya. Semua irama, recovery AI penuh, riwayat satu tahun.', hours: 'Suite recovery AI penuh', response: 'Harian · mingguan · bulanan', includes: ['Semua di Growth', 'Backup harian, mingguan, dan bulanan, disimpan 12 bulan', 'Recovery AI untuk aplikasi dan database-nya bersamaan', 'Restore titik-waktu dan reset tabel selektif', 'Pemeriksaan integritas setelah tiap backup dan restore', 'Aktivitas backup dan recovery bisa diekspor untuk audit'] },
    'care-enterprise': { blurb: 'Untuk sistem multi-situs dan teregulasi. Jadwal khusus, recovery multi-database, dan restore yang digladi — dilingkup sesuai arsitektur Anda.', hours: 'Recovery AI multi-situs', response: 'Jadwal khusus', includes: ['Semua di Business', 'Backup dan recovery lintas beberapa situs dan database', 'Retensi dan irama khusus per sistem', 'Pemulihan bencana yang digladi dan bisa Anda jalankan sesuai permintaan', 'Bawa model atau endpoint sendiri untuk recovery AI', 'Runbook serah terima agar tim Anda sendiri bisa mengoperasikannya'] },
  },
};
