...
const EN: Dict = {
  ...
  'footer.templates': 'Ready-made SaaS templates',
  ...
  'footer.maintenance': 'AI backup & recovery',
  ...
  'footer.legal': 'All prices are indicative European market rates in euros, quoted before VAT where applicable, and are confirmed in writing after a scope review. Setup and the AI backup-and-recovery install are priced separately from the build. Domain registration, third-party licences, payment gateway fees and external API usage are billed at cost.',
  ...
  'home.after.title': 'Set up once. Then it backs up and repairs itself.',
  'home.after.lead': 'The build price covers the build. Getting you live is a one-time setup. Keeping you safe is an AI backup-and-recovery system installed once — you back up, restore, reset the database and run an AI web-fix yourself, on your own AI key. No 24/7 SLA, no monthly retainer.',
  ...
  'home.care.monthly': 'Installed once',
  'home.care.title': 'AI Backup & Recovery',
  'home.care.body': 'One-click daily, weekly and monthly backups, one-click restore, one-click database reset and an AI web-fix that repairs the site — self-served from your portal on your own AI key, and every action recorded.',
  'home.care.link': 'See backup & recovery →',
  // Home — stat strip
...
const ES: Dict = {
  ...
  'footer.templates': 'Plantillas SaaS listas',
  ...
  'footer.maintenance': 'Backup y recuperación IA',
  ...
  'home.after.title': 'Configúralo una vez. Luego se respalda y se repara solo.',
  'home.after.lead': 'El precio del desarrollo cubre el desarrollo. Ponerte en marcha es un servicio único. Mantenerte a salvo es un sistema de backup y recuperación con IA instalado una vez — respaldas, restauras, reseteas la base de datos y ejecutas un web-fix IA tú mismo, sobre tu propia API key. Sin SLA 24/7, sin retención mensual.',
  ...
  'home.care.monthly': 'Instalado una vez',
  'home.care.title': 'Backup y Recuperación IA',
  'home.care.body': 'Backups diarios, semanales y mensuales con un clic, restauración con un clic, reseteo de la base de datos con un clic y un web-fix IA que repara el sitio — autogestionado desde tu portal con tu propia API key, y cada acción registrada.',
  'home.care.link': 'Ver backup y recuperación →',
...
const ID: Dict = {
  ...
  'footer.templates': 'Template SaaS siap pakai',
  ...
  'footer.maintenance': 'Backup & recovery AI',
  ...
  'footer.legal': 'Semua harga adalah perkiraan tarif pasar Eropa dalam euro, belum termasuk PPN bila berlaku, dan dikonfirmasi tertulis setelah tinjauan ruang lingkup. Setup dan pemasangan backup dan recovery AI dihitung terpisah dari biaya pembuatan. Registrasi domain, lisensi pihak ketiga, biaya payment gateway, dan penggunaan API eksternal ditagih sesuai biaya.',
  ...
  'home.after.title': 'Pasang sekali. Lalu ia mem-backup dan memperbaiki dirinya.',
  'home.after.lead': 'Harga pembuatan mencakup pembuatan. Membuat Anda online adalah setup sekali bayar. Menjaga Anda aman adalah sistem backup dan recovery AI yang dipasang sekali — Anda backup, restore, reset database, dan menjalankan web-fix AI sendiri, di atas API key AI Anda. Tanpa SLA 24/7, tanpa biaya bulanan.',
  ...
  'home.care.monthly': 'Dipasang sekali',
  'home.care.title': 'Backup & Recovery AI',
  'home.care.body': 'Backup harian, mingguan, dan bulanan satu klik, restore satu klik, reset database satu klik, dan web-fix AI yang memperbaiki situs — dijalankan sendiri dari portal Anda di atas API key AI Anda, dan tiap aksi tercatat.',
  'home.care.link': 'Lihat backup & recovery →',
