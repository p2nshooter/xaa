    ...
    <>
      <section className="relative overflow-hidden metal-wash text-ivory-50">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16">
          <span className="mk-chip border-white/25 text-ivory-100">Payments</span>
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <article className="panel p-7">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="font-serif text-2xl font-black">USDT</h2>
                <p className="text-sm text-steel-500">Tether, on three networks</p>
              </div>
            </div>
            <p className="mt-4 text-sm leading-relaxed text-ink-800/75">
            ...
            <div className="mt-5 rounded-lg bg-ivory-100/70 p-4 text-sm">
              ...
              <p className="mt-1 text-ink-800/75">
          ...
          <article className="panel p-7">
            <div className="flex items-center gap-3">
              <span className="mk-icon-bubble text-gold-500">₽</span>
              <div>
                <h2 className="font-serif text-2xl font-black">PayPal</h2>
        ...
        <ol className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
          {[
            ...
            <li key={s.n} className="premium-card p-5">
              <span className="font-serif text-2xl font-black accent-text">{s.n}</span>
              <p className="mt-2 text-sm font-bold">{s.t}</p>
              <p className="mt-1 text-xs leading-relaxed text-ink-800/70">{s.b}</p>
            </li>
          ))}
        </ol>
      </section>
      ...
      <section className="mx-auto max-w-6xl px-4 py-12">
        <div className="grid gap-6 md:grid-cols-2">
          <div className="panel p-6">
            <h2 className="font-serif text-xl font-black">Invoices, VAT and receipts</h2>
            <ul className="mt-4 space-y-2.5 text-sm text-ink-800/75">
          ...
          <div className="panel p-6">
            <h2 className="font-serif text-xl font-black">Refunds and cancellation</h2>
            <ul className="mt-4 space-y-2.5 text-sm text-ink-800/75">
      ...
      <section className="mx-auto max-w-6xl px-4 pb-6">
        <div className="panel border-l-4 border-l-[color:var(--accent)] p-6">
          <h2 className="font-serif text-lg font-black">Security: how to know a payment request is really from us</h2>
