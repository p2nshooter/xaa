...
export default async function NewProjectPage({
  ...
  if (!(await portalReady())) {
    return (
      <div className="mx-auto max-w-2xl px-4 py-20 text-center">
        <h1 className="font-display text-3xl font-extrabold">The order form is not switched on yet</h1>
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-12">
      <p className="text-[11px] font-extrabold uppercase tracking-[0.2em] text-gold-500">New project</p>
      <h1 className="mt-1 font-display text-3xl font-extrabold sm:text-4xl">Open a project</h1>
