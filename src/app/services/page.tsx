...
const COPY: Record<Lang, Copy> = {
  en: {
    ...
    glanceEyebrow: 'At a glance', glanceTitle: 'All ten packages', glanceLead: 'Prices are one-time build costs. Setup and monthly maintenance are separate — see Setup & Care.',
    ...
    tierBlurb: {
      ...
      enterprise: 'Multi-audience platforms, marketplaces and systems run to an SLA.',
    },
  ...
  es: {
    ...
    glanceEyebrow: 'De un vistazo', glanceTitle: 'Los diez paquetes', glanceLead: 'Los precios son costes de desarrollo únicos. La puesta en marcha y el mantenimiento mensual van aparte — ver Puesta en marcha y Mantenimiento.',
    ...
    tierBlurb: {
      ...
      enterprise: 'Plataformas multi-audiencia, marketplaces y sistemas operados con SLA.',
    },
  ...
  id: {
    ...
    glanceEyebrow: 'Sekilas', glanceTitle: 'Sepuluh paket', glanceLead: 'Harga adalah biaya pembuatan sekali bayar. Setup dan perawatan bulanan terpisah — lihat Setup & Perawatan.',
    ...
    tierBlurb: {
      ...
      enterprise: 'Platform multi-audiens, marketplace, dan sistem yang dijalankan dengan SLA.',
    },
