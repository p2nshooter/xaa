...
const COPY: Record<Lang, Copy> = {
  en: {
    ...
    careLead: 'This replaces the old monthly SLA. Backup and recovery of the database work directly — no AI key needed: plain snapshots you back up, download, restore or reset with one click. An AI key is optional, only for the self-healing web-fix. The system is installed once and you drive it yourself.',
  ...
  es: {
    ...
    careLead: 'Esto reemplaza el antiguo SLA mensual. El backup y la recuperación de la base de datos funcionan directamente — sin API key de IA: snapshots simples que respaldas, descargas, restauras o reseteas con un clic. Una API key es opcional, solo para el web-fix de autorreparación. El sistema se instala una vez y lo gestionas tú.',
  ...
  id: {
    ...
    careLead: 'Ini menggantikan SLA bulanan yang lama. Backup dan recovery database berjalan langsung — tanpa API key AI: snapshot sederhana yang Anda backup, unduh, restore, atau reset dengan satu klik. API key AI opsional, hanya untuk web-fix swa-perbaikan. Sistem dipasang sekali dan Anda kendalikan sendiri.',
